...
public class MainActivity extends Activity {
    ...
    private TextView averagePaceText;
    ...
    private TextView menuItem(String text, int size) {

        TextView view = new TextView(this);

        view.setText(text);
        view.setTextSize(size);
        view.setTextColor(Color.rgb(28, 35, 40));
        view.setPadding(20, 28, 20, 28);
    ...
    private void showRunScreen() {
        ...
        metrics.setPadding(10, 0, 10, 5);

        timeText = metric("Время\n00:00:00");
        distanceText = metric("Дистанция\n0.00 км");
        paceText = metric("Темп\n—");
        averagePaceText = metric("Средний темп\n—");
        caloriesText = metric("Калории\n0 ккал");

        metrics.addView(timeText);
        metrics.addView(distanceText);
        metrics.addView(paceText);
        metrics.addView(averagePaceText);
        ...
        trackLine.setColor(Color.rgb(22, 160, 133));
        ...
        pause.setOnClickListener(v -> pauseRun());
        finish.setOnClickListener(v -> finishRun());
    }
    ...
    private void startRun() {
        ...
        if (!running) {
            ...
            if (trackLine != null) {
                trackLine.setPoints(points);
            }

        } else {

            pausedTime +=
                    System.currentTimeMillis() - pauseStarted;
    ...
    private void updateMetrics() {
        ...
        if (km > 0 && seconds > 0) {
            ...
            paceText.setText("Темп\n—");
            averagePaceText.setText("Средний темп\n—");
        }
    ...
    private void finishRun() {
        ...
        showResultScreen(elapsed);
    }

    private void saveRun(long elapsed) {
    ...
    private void showResultScreen(long elapsed) {

        createBase("Результат");
        ...
        result.setTextColor(Color.rgb(28, 35, 40));
        ...
        history.setText("Открыть историю");
    ...
    private void showHistoryScreen() {
        ...
        try {
            ...
            if (history.length() == 0) {
                ...
                empty.setText("Пробежек пока нет");
    ...
    private void showStatisticsScreen() {
        ...
        createBase("Статистика");

        LinearLayout box = new LinearLayout(this);

        box.setOrientation(LinearLayout.VERTICAL);
        box.setPadding(25, 30, 25, 20);
        ...
        stats.setTextColor(Color.rgb(28, 35, 40));
    ...
    private void base(String title) {
        ...
        titleText.setTextColor(Color.rgb(28, 35, 40));
    ...
    private void showMenu() {
        ...
        TextView head = menuItem("RUNINTERVALS", 22);
        TextView run = menuItem("🏃  Пробежка", 18);
        TextView history = menuItem("📋  История", 18);
        TextView statistics = menuItem("📊  Статистика", 18);
        TextView settings = menuItem("⚙  Настройки", 18);
    ...
    private void updateMetrics() {
        ...
        if (km > 0 && seconds > 0) {
            ...
            setPaceText(paceText, "Темп", pace);
            setPaceText(averagePaceText, "Средний темп", pace);
